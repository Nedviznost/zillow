...
const PopoverButton = ({
  ...
  return (
    <HeadlessPopover.Button
      className={`${className} flex self-end justify-end  items-end py-1 select-none hover:text-primary-700 rounded-none ${
...
const PopoverPanelMainMenu = ({
  ...
  <Transition
    ...
    className='absolute inset-x-0 z-40 gap-6 px-2 pt-2 pb-6  top-11'
  >
